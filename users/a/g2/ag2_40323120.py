...
ag2_40323120 = Blueprint('ag2_40323120', __name__, url_prefix='/ag2_40323120', template_folder='templates')
...
@ag2_40323120.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@ag2_40323120.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@ag2_40323120.route('/circle1/<x>/<degree>', defaults={'y': 0})
@ag2_40323120.route('/circle1/<x>/<y>/<degree>')
...
@ag2_40323120.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@ag2_40323120.route('/circle2/<x>/<degree>', defaults={'y': 0})
@ag2_40323120.route('/circle2/<x>/<y>/<degree>')
#@ag2_40323120.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@ag2_40323120.route('/twocircle/<x>/<y>')
@ag2_40323120.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@ag2_40323120.route('/eighteenthirty/<x>/<y>')
@ag2_40323120.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@ag2_40323120.route('/snap')
